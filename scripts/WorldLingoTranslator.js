(function ($) {
    ...
    var root = this,
        ...
        WorldLingoTranslator;
    
    WorldLingoTranslator = function () {
        ...
        self.getBaseUrl = function () {
            return "worldlingo/translator.php";
        };
        ...
        self.ajaxCall = function () {
            console.log("WorldLingo!", "URL: ", self.getUrl());
            return $.ajax({
                url: self.getUrl(),
                dataType: 'json',
                scriptCharset: "utf-8"
    ...
    root.WorldLingoTranslator = WorldLingoTranslator;
    
}).call(this, jQuery);
//$.fn.WorldLingoTranslator = this.WorldLingoTranslator;